const cons = {
  ...
  supportEventTypes: ['m.room.create', 'm.room.name', 'm.room.topic', 'm.room.avatar', 'm.room.message', 'm.room.encrypted', 'm.room.member', 'm.sticker'],
  notifs: {
    DEFAULT: 'default',
  ...
  actions: {
    ...
    settings: {
      ...
      TOGGLE_ROOM_EVENT: 'TOGGLE_ROOM_EVENT',
  ...
  events: {
    ...
    settings: {
      ...
      ROOM_EVENTS_TOGGLED: 'ROOM_EVENTS_TOGGLED',
