          ...
          <Menu style={{ padding: config.space.S100 }}>
            <Box gap="100">
              <TooltipProvider
                tooltip={
                  <BtnTooltip
                    text={t('heading1', { defaultValue: 'Heading 1' })}
                    shortCode={`${modKey} + 1`}
                  />
                }
                delay={500}
              ...
              <TooltipProvider
                tooltip={
                  <BtnTooltip
                    text={t('heading2', { defaultValue: 'Heading 2' })}
                    shortCode={`${modKey} + 2`}
                  />
                }
                delay={500}
              ...
              <TooltipProvider
                tooltip={
                  <BtnTooltip
                    text={t('heading3', { defaultValue: 'Heading 3' })}
                    shortCode={`${modKey} + 3`}
                  />
                }
                delay={500}
    ...
    <TooltipProvider tooltip={tooltip} delay={500}>
      {(triggerRef) => (
        <IconButton
          ...
          radii="300"
        >
          <Text size="B400">{`${t('exit', { defaultValue: 'Exit' })} ${KeySymbol.Hyper}`}</Text>
        </IconButton>
      )}
    </TooltipProvider>
  );
        ...
        <Box className={css.EditorToolbar} alignItems="Center" gap="300">
          <>
            <Box shrink="No" gap="100">
              <MarkButton
                ...
                icon={Icons.Bold}
                tooltip={<BtnTooltip text={t('bold', { defaultValue: 'Bold' })} shortCode={`${modKey} + B`} />}
              />
              <MarkButton
                format={MarkType.Italic}
                icon={Icons.Italic}
                tooltip={
                  <BtnTooltip text={t('italic', { defaultValue: 'Italic' })} shortCode={`${modKey} + I`} />
                }
              />
              <MarkButton
                ...
                tooltip={
                  <BtnTooltip
                    text={t('underline', { defaultValue: 'Underline' })}
                    shortCode={`${modKey} + U`}
                  />
                }
              />
              <MarkButton
                ...
                tooltip={
                  <BtnTooltip
                    text={t('strikeThrough', { defaultValue: 'Strike Through' })}
                    shortCode={`${modKey} + S`}
                  />
                }
              />
              <MarkButton
                ...
                tooltip={
                  <BtnTooltip
                    text={t('inlineCode', { defaultValue: 'Inline Code' })}
                    shortCode={`${modKey} + [`}
                  />
                }
              />
          ...
          <Box shrink="No" gap="100">
            <BlockButton
              ...
              tooltip={
                <BtnTooltip
                  text={t('blockQuote', { defaultValue: 'Block Quote' })}
                  shortCode={`${modKey} + '`}
                />
              }
            />
            <BlockButton
              ...
              tooltip={
                <BtnTooltip
                  text={t('blockCode', { defaultValue: 'Block Code' })}
                  shortCode={`${modKey} + ;`}
                />
              }
            />
            <BlockButton
              ...
              tooltip={
                <BtnTooltip
                  text={t('orderedList', { defaultValue: 'Ordered List' })}
                  shortCode={`${modKey} + 7`}
                />
              }
            />
            <BlockButton
              ...
              tooltip={
                <BtnTooltip
                  text={t('unorderedList', { defaultValue: 'Unordered List' })}
                  shortCode={`${modKey} + 8`}
                />
              }
            />
            ...
            <>
              ...
              <Box shrink="No" gap="100">
                <ExitFormatting
                  tooltip={
                    <BtnTooltip
                      text={t('exitFormatting', { defaultValue: 'Exit Formatting' })}
            ...
            <TooltipProvider
              ...
              tooltip={
                <BtnTooltip
                  text={
                    isMarkdown
                      ? t('disableMarkdown', { defaultValue: 'Disable Markdown' })
                      : t('enableMarkdown', { defaultValue: 'Enable Markdown' })
                  }
                />
              }
              delay={500}
