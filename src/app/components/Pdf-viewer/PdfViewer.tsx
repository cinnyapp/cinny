      ...
      <Box className={classNames(css.PdfViewer, className)} direction="Column" {...props} ref={ref}>
        <Header className={css.PdfViewerHeader} size="400">
          ...
          <Box shrink="No" alignItems="Center" gap="200">
            ...
            >
              <Text size="B300">{t('download', { defaultValue: 'Download' })}</Text>
            </Chip>
          </Box>
        </Header>
        <Box direction="Column" grow="Yes" alignItems="Center" justifyContent="Center" gap="200">
          ...
          {isError && (
            <>
              <Text>{t('failedToLoadPdf', { defaultValue: 'Failed to load PDF' })}</Text>
              <Button
                variant="Critical"
                fill="Soft"
                size="300"
        ...
        {docState.status === AsyncStatus.Success && (
          <Header as="footer" className={css.PdfViewerFooter} size="400">
            ...
            >
              <Text size="B300">{t('previous', { defaultValue: 'Previous' })}</Text>
            </Chip>
                    ...
                    <Menu variant="Surface">
                      ...
                      >
                        <Input
                          ...
                          type="number"
                          radii="300"
                          aria-label={t('pageNumber', { defaultValue: 'Page Number' })}
                        />
                        <Button type="submit" size="300" variant="Primary" radii="300">
                          <Text size="B300">{t('jumpToPage', { defaultValue: 'Jump To Page' })}</Text>
                        </Button>
                      </Box>
                    </Menu>
                  </FocusTrap>
            ...
            >
              <Text size="B300">{t('next', { defaultValue: 'Next' })}</Text>
            </Chip>
          </Header>
        )}
      </Box>
