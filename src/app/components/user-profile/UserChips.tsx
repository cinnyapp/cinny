        ...
        >
          <Menu>
            <div style={{ padding: config.space.S100 }}>
              ...
              >
                <Text size="B300">{t('copyServer', { defaultValue: 'Copy Server' })}</Text>
              </MenuItem>
              <MenuItem
                variant="Surface"
                fill="None"
              ...
              >
                <Text size="B300">{t('exploreCommunity', { defaultValue: 'Explore Community' })}</Text>
              </MenuItem>
            </div>
            <Line size="300" />
            <div style={{ padding: config.space.S100 }}>
              ...
              >
                <Text size="B300">{t('openInBrowser', { defaultValue: 'Open in Browser' })}</Text>
              </MenuItem>
            </div>
          </Menu>
        </FocusTrap>
        ...
        >
          <Menu>
            <div style={{ padding: config.space.S100 }}>
              ...
              >
                <Text size="B300">{t('copyUserId', { defaultValue: 'Copy User ID' })}</Text>
              </MenuItem>
              <MenuItem
                variant="Surface"
                fill="None"
              ...
              >
                <Text size="B300">{t('copyUserLink', { defaultValue: 'Copy User Link' })}</Text>
              </MenuItem>
            </div>
          </Menu>
        </FocusTrap>
                ...
                <Scroll size="300" hideTrack>
                  ...
                  >
                    ...
                    {mutual.directs.length > 0 && (
                      <Box direction="Column" gap="100">
                        <Text style={{ paddingLeft: config.space.S100 }} size="L400">
                          {t('directMessages', { defaultValue: 'Direct Messages' })}
                        </Text>
    ...
    >
      ...
      >
        <Text size="B300">
          {mutualRoomsState.status === AsyncStatus.Success &&
            t('mutualRooms', {
              defaultValue: '{{count}} Mutual Rooms',
              count: mutualRoomsState.data.length,
            })}
          {mutualRoomsState.status === AsyncStatus.Loading &&
            t('mutualRoomsLoading', { defaultValue: 'Mutual Rooms' })}
        </Text>
      </Chip>
    </PopOut>
  );
      ...
      <SettingTile>
        <Box direction="Column" gap="200">
          <Box gap="200" justifyContent="SpaceBetween">
            <Text size="L400">{t('blockedUser', { defaultValue: 'Blocked User' })}</Text>
          </Box>
          <Box direction="Column">
            <Text size="T200">
              {t('blockedUserDescription', {
                defaultValue: 'You do not receive any messages or invites from this user.',
              })}
            </Text>
          </Box>
        </Box>
          ...
          <Menu>
            <div style={{ padding: config.space.S100 }}>
              ...
              >
                <Text size="B300">
                  {ignored
                    ? t('unblockUser', { defaultValue: 'Unblock User' })
                    : t('blockUser', { defaultValue: 'Block User' })}
                </Text>
              </MenuItem>
            </div>
          </Menu>
