...
export function SSOStage({
  ...
  return (
    <Dialog>
      ...
      >
        <Box grow="Yes">
          <Text size="H4">{t('ssoLoginTitle', { defaultValue: 'SSO Login' })}</Text>
        </Box>
      ...
      >
        <Text size="T200">
          {t('ssoAuthDescription', {
            defaultValue: 'To perform this action you need to authenticate yourself by SSO login.',
          })}
        </Text>
        {errorCode && (
        ...
        {ssoWindow ? (
          ...
          <Button variant="Primary" onClick={handleContinue}>
            <Text as="span" size="B400">
              {t('continueWithSso', { defaultValue: 'Continue with SSO' })}
            </Text>
          </Button>
        )}
      </Box>
