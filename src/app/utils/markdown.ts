...
export const parseInlineMD = (text: string): string => {
  ...
  if (linkMatch) {
    ...
    return `${before}<a data-md-tag href="${g2}">${child}</a>${after}`;
  }
  ...
  if (boldMatch) {
    ...
    return `${before}<strong data-md-tag>${child}</strong>${after}`;
  }
  ...
  if (underlineMatch) {
    ...
    return `${before}<u data-md-tag>${child}</u>${after}`;
  }
  ...
  if (italicMatch) {
    ...
    return `${before}<i data-md-tag>${child}</i>${after}`;
  }
  ...
  if (strikeMatch) {
    ...
    return `${before}<s data-md-tag>${child}</s>${after}`;
  }
  ...
  if (codeMatch) {
    ...
    return `${before}<code data-md-tag>${child}</code>${after}`;
  }
  ...
  if (spoilerMatch) {
    ...
    return `${before}<span data-md-tag data-mx-spoiler>${child}</span>${after}`;
  }
