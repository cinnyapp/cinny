...
export const UnreadMenu = forwardRef<
  HTMLDivElement,
  { rooms: string[]; getToLink: (roomId: string) => string; requestClose: () => void }
>(({ rooms, getToLink, requestClose }, ref) => {
            ...
            {rooms
              ...
              .map((roomId) => {
                ...
                return (
                  ...
                  >
                    <NavLink onClick={requestClose} to={getToLink(roomId)}>
...
export function NotificationBadge({
  ...
  unread: Unread;
  renderUnreadMenu: (requestClose: () => void) => ReactNode;
}) {
  ...
  return (
    <PopOut
      ...
      content={
        ...
        >
          {renderUnreadMenu(closeUnreadMenu)}
        </FocusTrap>
      }
      position="Bottom"
      align="Start"
