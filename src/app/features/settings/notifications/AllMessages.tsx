  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('allMessagesHeader', { defaultValue: 'All Messages' })}</Text>
        <Box gap="100">
      ...
      >
        <SettingTile
          title={t('oneToOneChats', { defaultValue: '1-to-1 Chats' })}
      ...
      >
        <SettingTile
          title={t('oneToOneChatsEncrypted', { defaultValue: '1-to-1 Chats (Encrypted)' })}
          after={
      ...
      >
        <SettingTile
          title={t('rooms', { defaultValue: 'Rooms' })}
      ...
      >
        <SettingTile
          title={t('roomsEncrypted', { defaultValue: 'Rooms (Encrypted)' })}
          after={
            <AllMessagesModeSwitcher
              pushRules={pushRules}
