  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">
          {t('specialMessagesHeader', { defaultValue: 'Special Messages' })}
        </Text>
        <Box gap="100">
          <Text size="T200">{t('badgeLabel', { defaultValue: 'Badge:' })} </Text>
      ...
      >
        <SettingTile
          title={t('mentionUserId', {
            defaultValue: 'Mention User ID ("{{userId}}")',
            userId,
          })}
          after={
            <MentionModeSwitcher
      ...
      >
        <SettingTile
          title={t('containsDisplayName', {
            defaultValue: 'Contains Displayname{{suffix}}',
            suffix: displayName ? ` ("${displayName}")` : '',
          })}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={t('containsUsername', {
            defaultValue: 'Contains Username ("{{username}}")',
      ...
      >
        <SettingTile
          title={t('mentionRoom', { defaultValue: 'Mention @room' })}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={t('containsRoom', { defaultValue: 'Contains @room' })}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
