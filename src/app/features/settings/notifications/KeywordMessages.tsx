  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">
          {t('keywordMessagesHeader', { defaultValue: 'Keyword Messages' })}
        </Text>
        <Box gap="100">
      ...
      >
        <SettingTile
          title={t('selectKeywordTitle', { defaultValue: 'Select Keyword' })}
          description={t('selectKeywordDescription', {
            defaultValue:
              'Set a notification preference for message containing given keyword.',
          })}
        >
          <KeywordInput />
        </SettingTile>
