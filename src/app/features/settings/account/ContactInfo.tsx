...
export function ContactInformation() {
  ...
  return (
    <Box direction="Column" gap="100">
      <Text size="L400">
        {t('contactInformationHeader', { defaultValue: 'Contact Information' })}
      </Text>
      <SequenceCard
      ...
      >
        <SettingTile
          title={t('emailAddressTitle', { defaultValue: 'Email Address' })}
          description={t('emailAddressDescription', {
            defaultValue: 'Email address attached to your account.',
          })}
        >
          <Box>
            {emailIds?.map((email) => (
